...
class RoutineForm(forms.ModelForm):
    ...
    def clean_name(self):
        ...
        if name:
            ...
            # Verificar se já existe uma rotina com este nome para o mesmo usuário
...
class ExerciseForm(forms.ModelForm):
    ...
    def clean_name(self):
        ...
        if name:
            ...
            # Verificar se já existe um exercício com este nome para o mesmo usuário
            if hasattr(self, 'user'):
...
class RoutineExerciseForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'sets': forms.NumberInput(attrs={'class': 'form-control', 'min': 1, 'max': 20}),
        }
        labels = {
            'exercise': 'Exercício',
...
class SetLogForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'weight': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.5', 'min': '0', 'max': '1000'}),
            'reps': forms.NumberInput(attrs={'class': 'form-control', 'min': '1', 'max': '1000'}),
